...
export class Landscape extends Mesh {
    ...
    constructor( o = {} ) {
        ...
        if( this.isTurn ) this.geometry.rotateY( -math.PI90 );
    ...
    addBorder ( o ){
        ...
        this.borderGeometry = BufferGeometryUtils.mergeVertices( BufferGeometryUtils.mergeBufferGeometries( [ front, back, left, right ] ) );
    ...
    update ( wait ) {
        ...
        while( i-- ){
            ...
            var ccc = math.clamp(cc[0]+0.25, 0.25, 1)
        ...
        if( this.isBorder ){
            ...
            while(j--){
                ...
                if(this.list[j]!==-1){
                    ...
                    var ccc = math.clamp(h+0.25, 0.25, 1)
                    var ee = (0.5 + h+0.5);
                    ee = ee > 1 ? 1 : ee;
                    ee = ee < 0.5 ? 0.5 : ee;
