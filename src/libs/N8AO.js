import {
    Color as $5Whe3$Color, WebGLRenderTarget as $5Whe3$WebGLRenderTarget, LinearFilter as $5Whe3$LinearFilter, NearestFilter as $5Whe3$NearestFilter, HalfFloatType as $5Whe3$HalfFloatType, 
    RGBAFormat as $5Whe3$RGBAFormat, DepthTexture as $5Whe3$DepthTexture, UnsignedInt248Type as $5Whe3$UnsignedInt248Type, UnsignedIntType as $5Whe3$UnsignedIntType, 
    DepthStencilFormat as $5Whe3$DepthStencilFormat, DepthFormat as $5Whe3$DepthFormat, Matrix4 as $5Whe3$Matrix4, DataTexture as $5Whe3$DataTexture, ShaderMaterial as $5Whe3$ShaderMaterial, 
    NoColorSpace as $5Whe3$NoColorSpace, RepeatWrapping as $5Whe3$RepeatWrapping, Vector2 as $5Whe3$Vector2, REVISION as $5Whe3$REVISION, RedFormat as $5Whe3$RedFormat, FloatType as $5Whe3$FloatType, 
    Vector3 as $5Whe3$Vector3, Sphere as $5Whe3$Sphere, BufferAttribute as $5Whe3$BufferAttribute, BufferGeometry as $5Whe3$BufferGeometry, OrthographicCamera as $5Whe3$OrthographicCamera, Mesh as $5Whe3$Mesh,
    BasicDepthPacking, Camera, Material, Scene, Texture, Float32BufferAttribute
} from "three";
import {Pass as $5Whe3$Pass} from "three/addons/postprocessing/Pass.js";


///////////////////////////
// PASS from postprocess

const fullscreenGeometry = /* @__PURE__ */ (() => {

    const geometry = new $5Whe3$BufferGeometry();
...
export class $5Whe3$Pass1 {

    static get fullscreenGeometry() { return fullscreenGeometry; }
    ...
    set fullscreenMaterial(value) {
        ...
        if(screen !== null) {
            ...
            screen = new $5Whe3$Mesh(Pass.fullscreenGeometry, value);
    ...
    setFullscreenMaterial(value) { this.fullscreenMaterial = value; }

    getDepthTexture() { return null; }

    setDepthTexture(depthTexture, depthPacking = BasicDepthPacking) {}

    render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) { throw new Error("Render method not implemented!"); }
...
class $e4ca8dcb0218f846$var$FullScreenTriangleGeometry extends $5Whe3$BufferGeometry {
    ...
    constructor(){
        super();
        this.setAttribute("position", new $5Whe3$BufferAttribute(new Float32Array([-1,-1,3,-1,-1,3]), 2));
        this.setAttribute("uv", new $5Whe3$BufferAttribute(new Float32Array([0,0,2,0,0,2]), 2));
    }
