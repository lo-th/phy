	...
	get:( name ) => {
		...
		if( !mat[name] ){
			...
			switch( name ){
				...
				case 'glass2': m = Mat.create({ name:'glass2', color:0xEEEEEE, transparent:true, opacity:0.3  }); break
				case 'glass3': m = Mat.create({ name:'glass3', color:0x000000, metalness: 0, roughness: 0, transparent:true, opacity:0.4  }); break
