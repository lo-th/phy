...
demo = () => {
    ...
    phy.addButton({ type:'cylinder', pos:[1,0,0], size:[1,1], radius:0.2, seg:32, callback:ab2, text:'O' })
    phy.addButton({ type:'cylinder', pos:[4,0,0], size:[1,1], radius:0.2, seg:6, callback:ab3, text:'X' })
