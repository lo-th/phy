...
function demo() {
    ...
    // create character
    let r = 0.3
    bob = phy.add({ type:'capsule', name:'bob', material:'hero', size:[ r,1.8-(2*r) ], pos:[0,3,0], angularFactor:[0,1,0], density:2, damping:[0.01,0], friction:0.8, group:32 });
    bob.rotation.order = 'YXZ';
